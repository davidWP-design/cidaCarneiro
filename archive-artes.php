		...
		<?php get_header(); ?>
			<div class="conteudo col-sm-12 col-md-9 col-lg-9 col-xl-9 order-sm-2 ">
				...
				<?php if( $query->have_posts()) : while( $query->have_posts() ) : $query->the_post(); ?>	
                        ...
                        <!-- conteudo do box  -->
                        <div class="box-post mt-3 col-sm-6 col-md-6 col-lg-4 col-xl-4" data-aos="fade-up" data-aos-duration="3000" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
